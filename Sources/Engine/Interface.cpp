...
void Interface::Render(int Width, int Height)
{
    ...
    if (ImGui::BeginMaiBinEdit3nuBar()) {

        if (ImGui::BegiBinEdit3nu("File")) {
        ...
        if (ImGui::BegiBinEdit3nu("Insert"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Model"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Vertex"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Face"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Textures"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Groups"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Tools"))
        {

            ImGui::EndMenu();
        }
        if (ImGui::BegiBinEdit3nu("Help"))
        {
            if (ImGui::MenuItem("ReadMe.txt", "F1")) {

            }
            if (ImGui::MenuItem("About BinEdit3...", "", Config->General.About)) {
    ...
    if (Config->General.About) {
        ...
        ImGui::SameLine();
        ImGui::TextWrapped("%s %swww.Natas8.com/BinEdit3 %sJpez1432@gmail.com", GetInfo().c_str(), "\n", "\n");
        ImGui::Separator();
        ImGui::TextWrapped("BinEdit3 was created for simplicity, and ease of use. BinEdit3 uses OpenGL for accelerated graphics processing. It aims to be easy to use for all aspects of model editing. All questions, comments and bug reports are welcome.");
        ImGui::Separator();
        ImGui::Text("                               ");
        ImGui::SameLine();
...
//                    sprintf(Buffer, Model->Obj.Materials[CurrentMaterial].Name.c_str());
    ...
    if (ImGui::BeginPopup("Menu")) {
        ...
        if (ImGui::BegiBinEdit3nu("Projection")) {
        ...
        ImGui::Separator();
        if (ImGui::BegiBinEdit3nu("Render")) {
